  ...
  return (
    <div>
        ...
        {hightlightsSlides.map((list, idx) => (
          <div
            ...
            <div className="video-carousel_container">
              <div
                className="w-full h-full flex-center rounded-2xl
      ...
      <div className="relative flex-center mt-10">
        <div
          className="flex-center py-5 px-7 bg-gray-700 backdrop-blur-sm
            rounded-full">
          {videoRef.current.map((vid, idx) => (
            <span
              key={idx}
              ...
              <span
                ...
                ref={(el) => (videoSpanRef.current[idx] = el)}></span>
            </span>
          ))}
        </div>
